...
def getembedparam(accesstoken, REPORT_ID='', WORKSPACE_ID=''):
    '''Returns Embed token and Embed URL'''

    try:
        headers = {'Content-Type': 'application/json', 'Authorization': 'Bearer ' + accesstoken}

        reporturl = 'https://api.powerbi.com/v1.0/myorg/groups/' + WORKSPACE_ID + '/reports/' + REPORT_ID
        ...
        if WORKSPACE_ID != '':
            ...
            body['targetWorkspaces'].append({'id': WORKSPACE_ID})
